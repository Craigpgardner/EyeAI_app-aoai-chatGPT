...
class _UiSettings(BaseSettings):
    ...
    chat_description: str = "I am OphAI, I am here to assist with all things Ophthalmology! Got brainfog? Forgot where to put the 1+ cell? Just ask me and ill assist you!"
